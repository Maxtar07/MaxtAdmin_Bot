...
module.exports = (client, message, queue) => {
    ...
    .setAuthor("Bot déconnecté", image)
    .setDescription("La musique à été arrêtée car le bot à été déconnecté.")
    .setColor("BLUE")
    log_music.send(embed);
    //log_music.send(`${client.emotes.error} - La musique à été arrêtée car le bot à été déconnecté !`);
