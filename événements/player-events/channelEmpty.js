...
module.exports = (client, message, queue) => {
    ...
    .setAuthor("Salon vocal vide", image)
    .setDescription(`La musique à été arrêtée car le salon vocal est vide.`)
    .setColor("BLUE")
    log_music.send(embed);
    //log_music.send(`${client.emotes.error} - La musique à été arrêtée car plus personne n'était présent dans le channel !`);
